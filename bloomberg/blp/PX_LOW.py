...
from bloomberg.model.models import PXLOWModel
from xbbg import blp

class PX_LOW(BLPBase):
    """
    blp.bhs에서 PX_LOW 필드의 값입니다. 
    """

    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, PXLOWModel, kwargs)
        self._get()
        self._check_results()
