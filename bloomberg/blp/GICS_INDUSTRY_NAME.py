...
from bloomberg.model.models import GICSINDUSTRYNAMEModel
from xbbg import blp

class GICS_INDUSTRY_NAME(BLPBase):
    """
    blp.bdh에서 GICS_SCECTOR_NAME 필드의 값입니다. 
    """

    def __init__(self, security, **kwargs):
        super().__init__(security, self.__class__.__name__, GICSINDUSTRYNAMEModel, **kwargs)
        self._get()      
        self._check_results()  
