...
from bloomberg.model.models import PXOPENModel
from xbbg import blp

class PX_OPEN(BLPBase):
    """
    blp.bhs에서 PX_OPEN 필드의 값입니다. 
    """

    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, PXOPENModel, kwargs)
        self._get()
        self._check_results()
