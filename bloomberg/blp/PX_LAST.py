...
from bloomberg.model.models import PXLASTModel
from xbbg import blp

class PX_LAST(BLPBase):
    """
    blp.bhs에서 PX_LAST 필드의 값입니다. 
    """

    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, PXLASTModel, kwargs)
        self._get()
        self._check_results()
