...
from bloomberg.model.models import PXVOLUMEModel
from xbbg import blp

class PX_VOLUME(BLPBase):
    """
    blp.bhs에서 PX_VOLUME 필드의 값입니다. 
    """

    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, PXVOLUMEModel, kwargs)
        self._get()
        self._check_results()
