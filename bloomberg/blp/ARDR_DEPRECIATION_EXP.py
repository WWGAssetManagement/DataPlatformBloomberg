...
from bloomberg.model.models import ARDRDEPRECIATIONEXPModel
from xbbg import blp

class ARDR_DEPRECIATION_EXP(BLPBase):
    """
    ARDR_DEPRECIATION_EXP 데이터 수집 
    """
    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, ARDRDEPRECIATIONEXPModel, kwargs)
        self._get()
        self._check_results()
