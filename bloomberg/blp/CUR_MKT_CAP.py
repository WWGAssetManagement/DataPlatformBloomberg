...
from bloomberg.model.models import CURMKTCAPModel
from xbbg import blp

class CUR_MKT_CAP(BLPBase):
    """
    Current Market Cap 데이터 수집 
    """
    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, CURMKTCAPModel, kwargs)
        self._get()
        self._check_results()
