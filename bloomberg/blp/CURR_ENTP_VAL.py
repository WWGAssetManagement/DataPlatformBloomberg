...
from bloomberg.model.models import CURRENTPVALModel
from xbbg import blp

class CURR_ENTP_VAL(BLPBase):
    """
    Current EV Value 데이터 수집 
    """
    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, CURRENTPVALModel, kwargs)
        self._get()
        self._check_results()
