...
from bloomberg.model.models import CRNCYADJCURREVModel
from xbbg import blp

class CRNCY_ADJ_CURR_EV(BLPBase):
    """
    통화량 조정 기업가치 데이터 수집 
    """
    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, CRNCYADJCURREVModel, kwargs)
        self._get()
        self._check_results()
