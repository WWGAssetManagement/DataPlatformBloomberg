...
from bloomberg.model.models import RETURNONCAPITALADJUSTEDModel
from xbbg import blp

class RETURN_ON_CAPITAL_ADJUSTED(BLPBase):
    """
    RETURN_ON_CAPITAL_ADJUSTED 데이터 수집 
    """
    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, RETURNONCAPITALADJUSTEDModel, kwargs)
        self._get()
        self._check_results()
