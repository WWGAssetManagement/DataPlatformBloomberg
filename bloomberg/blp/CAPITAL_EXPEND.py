...
from bloomberg.model.models import CAPITALEXPENDModel
from xbbg import blp

class CAPITAL_EXPEND(BLPBase):
    """
    CAPITAL_EXPEND 데이터 수집 
    """
    def __init__(self, security, kwargs):
        super().__init__(security, self.__class__.__name__, CAPITALEXPENDModel, kwargs)
        self._get()
        self._check_results()
